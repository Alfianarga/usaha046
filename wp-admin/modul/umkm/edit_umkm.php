...
<body>
    <div class="container">
        ...
        <?php
            ...
            $id=$_GET['id'];
            $query = mysqli_query($koneksi, "SELECT * FROM tbumkm_3183111046 WHERE id_umkm='$id'");
       ...
       if(isset($_POST['submit'])) {
        ...
        if ($filename != "" ){
            ...
            if (!$size < 1050050) {
                    ...
                    $query = mysqli_query($koneksi, "SELECT * FROM tbumkm_3183111046 WHERE id_umkm='$id_umkm'");
                    ...
                    mysqli_query($koneksi, "UPDATE tbumkm_3183111046 SET nama_umkm='$nama_umkm',
