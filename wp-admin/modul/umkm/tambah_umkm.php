    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!-- <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="../umkm/umkm.php">UMKM</a>
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" class="form-control" name="id_umkm" placeholder="contoh:T03">
        ...
        <div class='gllpLatlonPicker'>
            ...
            <br /> <br />
            <input type='text' name='latitude' class='gllpLatitude' value='-7.795580' readonly/> &#8592 <font color='yellow'>Latitude</font> <br/> <br/>
            <input type='text' name='longitude' class='gllpLongitude' value='110.369490' readonly/> &#8592 <font color='yellow'>Longitude</font> <br/> <br/>
            ...
            $tampil = mysqli_query($koneksi, "SELECT * FROM tbkategori_3183111046 ORDER BY nama_kategori ASC");
            ...
            <div class="form-group">
                    ...
                    <textarea name="deskripsi_umkm" class="ckeditor"></textarea>
                </div>
       ...
       if(isset($_POST['submit'])) {
        ...
        if(!in_array($extension, $file_extension)) {
            ...
            if (!$size < 1050050) {
                ...
                mysqli_query($koneksi, "INSERT into tbumkm_3183111046  values('$id_umkm', '$nama_umkm','$kategori_umkm', '$lokasi_umkm','$latitude', '$longitude', '$nama_gambar', '$deskripsi_umkm' )");
