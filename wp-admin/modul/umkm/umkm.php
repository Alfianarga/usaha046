    ...
    <div class="container">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <!-- <li class="nav-item dropdown">
                ...
                <a class="dropdown-item" href="../wisata/wisata.php">UMKM</a>
        ...
        <br><a class="btn btn-primary" type="submit" href="tambah_umkm.php" > [+] Tambah UMKM</a>
        ...
        <table class="table mt-3">
            ...
            <tbody>
                ...
                <td>
                    <a class="btn btn-success" href="edit_umkm.php?id=<?php echo $r['id_umkm']?>" role="button">Edit</a>
                    <a class="btn btn-danger" href="hapus_umkm.php?id=<?php echo $r['id_umkm']?>" role="button" onclick="return confirm('Do You Want Delete?')">Delete</a> </td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
