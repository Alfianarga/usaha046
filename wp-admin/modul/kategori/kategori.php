         ...
         <thead class="thead-dark">
          ...
          <tbody>
           <?php
            ...
            $sql = mysqli_query($koneksi, "SELECT * FROM tbkategori_3183111046");
            $no= 1;
            while($a=mysqli_fetch_array($sql)){
                ...
                <td>
                <a class="btn btn-success" href ="edit_kategori.php?id=<?php echo $a['id_kategori']?>" role="button">Edit</a> 
                <a class="btn btn-danger" href="hapus_kategori.php?id=<?php echo $a['id_kategori']?>" role="button"  onclick="return confirm('Do You Want Delete?')">Delete</a>
                </td> 
                </tr>
            <?php } ?>
            </tbody>
