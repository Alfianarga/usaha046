...
<body>
    <div class="container">
        ...
        <input type="text" name="id_kategori" class="form-control" placeholder="Contoh: 2">
        <label for="formGroupExampleInput">Nama Kategori</label>
        <input type="text" name="nama_kategori" class="form-control" placeholder="Contoh: UMKM Kuliner">
        <br>
        </div>
        <br>
        <br>
        ...
        <?php
            ...
            if(isset($_POST['submit'])){
                ...
                $nama_kategori = $_POST['nama_kategori'];
                    mysqli_query($koneksi, "insert into tbkategori_3183111046 values('$id_kategori','$nama_kategori')");
